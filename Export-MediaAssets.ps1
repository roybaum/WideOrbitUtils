$projectModuleManifest = Join-Path -Path $PSScriptRoot -ChildPath 'Modules\WideOrbit\WideOrbit.psd1'
if (Test-Path $projectModuleManifest) {
    Import-Module -Name $projectModuleManifest -Force -ErrorAction SilentlyContinue
}
